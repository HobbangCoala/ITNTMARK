...
namespace ITNTMARK
{
    ...
    internal class PLCABTCP3
    {
        ...
        public PLCABTCP3(PLCDataArrivedCallbackHandler callback, PLCConnectionStatusChangedEventHandler connectFunc)
        {
        ...
        public ITNTResponseArgs OpenPLC(PLC_COMM_TYPE commType)
        {
            ...
            try
            {
                ...
                //args.errorInfo.devErrorInfo.sDeviceCode = DeviceCode.Device_PLC;
                //args.errorInfo.devErrorInfo.sDeviceName = DeviceName.Device_PLC;
                lock (cmdLock)
                {
                    LoadOption();
        ...
        public async Task<ITNTResponseArgs> SendLaserPowerError(byte status, int loglevel = 0, CancellationToken token = default)
        {
            ITNTResponseArgs retval = new ITNTResponseArgs(64);
            ITNTSendArgs sendArg = new ITNTSendArgs(64);
            byte[] recv = new byte[64];
