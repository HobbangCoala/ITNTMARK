...
namespace ITNTMARK
{
    ...
    internal class PLCABTCP6
    {
        ...
        private async void PLCStatusThread(object obj)
        {
            ...
            try
            {
                ...
                while (DoingPLCStatusThread)
                {
                    ...
                    //    //lock (cmdLock)
                    //    {
                    //        args = await ReadSignalFromPLC4Test();
                    ...
                    //    {
                    //        ITNTTraceLog.Instance.Trace(0, "{0}:{3:D4}:{1}()  {2}", className, funcName, "STATUS TIME = " + sw.ElapsedMilliseconds, Thread.CurrentThread.ManagedThreadId);
                    //    }
                    //}
        ...
        //private async void PLCHeartbeatThread(object obj)
        //{
        //    string className = "PLCABTCP2";
        //    string funcName = "PLCHeartbeatThread";
        ...
        private async Task TryReconnectAsync2()
        {
            string className = "LaserSourceController";
            string funcName = "TryReconnectAsync";
        ...
        public async Task<ITNTResponseArgs> SendLaserPowerLow(byte status, int loglevel = 0, CancellationToken token = default)
        {
            ITNTResponseArgs retval = new ITNTResponseArgs(64);
            ITNTSendArgs sendArg = new ITNTSendArgs(64);
            byte[] recv = new byte[64];
