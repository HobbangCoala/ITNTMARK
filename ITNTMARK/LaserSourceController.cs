...
//        }
        ...
        private ErrorInfo AnalysisResponseData(string func, string cmd, ITNTResponseArgs args)
        {
            string className = "LaserSourceController";
            ...
            try
            {
                ...
                if (args.recvString.Length > 3)
                {
                    ...
                    if (recvCMD == "ERR")
                    {
                        ...
                        retval.devErrorInfo.sErrorMessage = "LASER ERROR RESPONSE (" + cmd + ") = " + args.recvString;
